...
export class CartService {
  ...
  ServerURL = environment.serverURL;
   ...
   cartDataClient: CartModelPublic = {prodData: [{incart: 0, id: 0}], total: 0};  // This will be sent to the backend Server as post data
  ...
  CheckoutFromCart() {
    ...
    this.httpClient.post(`${this.ServerURL}/orders/payment`, null).subscribe((res: { success: boolean }) => {
      ...
      if (res.success) {
        ...
        // @ts-ignore
        this.httpClient.post(`${this.ServerURL}/orders/new`, {products: this.cartDataClient.prodData}).subscribe((data: OrderConfirmationResponse) => {
